    ...
    >
       <Helmet>
        ...
        <div className="landing-items margin-280px">
          <div className="landing-items-info"><Link to='/news'>
            <span>
          ...
          <div className="landing-items-info"><Link to='/ganckhadebebi'>
            <span> 
          ...
          <div className="landing-items-info"><Link to='/sajaroInfo'>
            <span> 
            {language ==1 ? " ბიუჯეტი"  :   ""}
              {language ==2 ? " Budget"  :   ""}
              {language ==3 ? " бюджет"  :   ""}
          ...
          <div className="landing-items-info"><Link to='/anonsebi'>
            <span> 
            {language ==1 ? "  ანონსები"  :   ""}
          ...
          <div className="landing-items-container margin-280px">
            ...
            <div className="about">
              <span><Link to='/news'>{language ==1 ? " სიახლეების გვერდი"  :   ""}
