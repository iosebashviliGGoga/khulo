...
function PrescentriPresrelizebi1() {
  ...
  .then((data) => {
   ...
   // console.log('სიახლეები', data.პრესრელიზები)
    setExactNews(data.პრესრელიზები[id].geo)
    ...
    {   
        if(i <= 1 ){
            ...
            <div>
              ...
              <span className='vrclad'><Link to={`/presrelizebi/${news[0]}`}>ვრცლად</Link></span>
            </div>
          </div></Link>
